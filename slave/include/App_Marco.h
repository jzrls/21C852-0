...
// for a 150MHz CPU clock speed (SYSCLKOUT)
...
// Enable /2 for SYSCLKOUT, SYSCLKOUT=VCOCLK/2=150MHZ
#define VCOCLK_DIVSEL 2
...
// SYSCLKOUT/(2*LOSPCP_RATIO*115200bps*8)-1
#define SCI_BAUD 0x28
// SCI相关的宏定义结束
//======================================================================================================
...
// 控制PI参数宏定义
// 速度环控制PI参数宏定义
#define VELO_I_NUM 100
#define KP_VELO _IQ(0.1)
#define KI_VELO _IQ(0.001)
#define KI_VELO_OUT_MAX _IQ(0.025)
#define KI_VELO_OUT_MIN _IQ(-0.025)
#define PI_VELO_OUT_MAX _IQ(0.025)
#define PI_VELO_OUT_MIN _IQ(-0.025)
#define VELO_CONTROL_PERIOD 10

// 电流环Iq控制PI参数宏定义
#define ID_I_NUM 30
#define KP_ID _IQ(0.2)
#define KI_ID _IQ(0.03)
#define KI_ID_OUT_MAX _IQ(7.8)
#define KI_ID_OUT_MIN _IQ(-7.8)
#define PI_ID_OUT_MAX _IQ(8)
#define PI_ID_OUT_MIN _IQ(-8)

#define ID_CONTROL_PERIOD 1

// 电流环Id控制PI参数宏定义
#define IQ_I_NUM 30
#define KP_IQ _IQ(0.2)
#define KI_IQ _IQ(0.03)
#define KI_IQ_OUT_MAX _IQ(7.8)
#define KI_IQ_OUT_MIN _IQ(-7.8)
#define PI_IQ_OUT_MAX _IQ(8)
#define PI_IQ_OUT_MIN _IQ(-8)

#define IQ_CONTROL_PERIOD 1
...
//-------------------------------------------------------
// 运行灯闪烁次数(多少个控制周期闪烁一次)
#define RUN_LED_PERIOD 10000
//---------------------------------------------------
//----------------------------------------------------
// 20110412使用电机 初始位置角
#define INIT_ANGLE 38616
//-------------------------------------------------------
