...
===========================================================================*/
#include "F28335_Device.h"     /* DSP2833x Headerfile Include File*/
#include "App_UserDef.h"   /* DSP2833x Examples Include File*/
...
/*EPWM1配置*/
	   ...
	   /* Setup counter mode*/
	   EPwm1Regs.TBCTL.bit.CTRMODE = 2; 	  /*00：增计数 01：减计数 10：增-减计数 11：stop freeze*/
	   EPwm1Regs.TBCTL.bit.PHSEN = 1;        /* 0：不从TBPHS下载到TBCTR 1：同步时从TBPHS下载到TBCTR*/
	   EPwm1Regs.TBPHS.half.TBPHS = 0x0000;           /* Phase is 0*/
	   EPwm1Regs.TBCTL.bit.SYNCOSEL = 1;              /*同步信号输出选择　00:EPWMxSYNC 01:CTR=ZERO 10:CTR=CMPB 11:Disable*/
	   /* Setup compare*/
	   EPwm1Regs.CMPCTL.bit.SHDWAMODE = 0;    /* 0:Enable影子比较寄存器  1:Disable*/
	   EPwm1Regs.CMPCTL.bit.SHDWBMODE = 0;
	   EPwm1Regs.CMPCTL.bit.LOADAMODE = 0;    /*下载影子比较寄存器 00:CTR=ZERO 01:CTR=PRD 10:CTR=ZERO or CTR=PRD  11:FREEZE*/
	   EPwm1Regs.CMPCTL.bit.LOADBMODE = 0;  
	   /* Set actions*/
	   EPwm1Regs.AQCTLA.bit.CAU = 2;             /* PWMA比较匹配输出状态 00：不动作 01：低 10：高 11：取反*/
	   EPwm1Regs.AQCTLA.bit.CAD = 1;   
	   EPwm1Regs.AQCTLB.bit.CAU = 2;          /* PWMB比较匹配输出状态 00：不动作 01：低 10：高 11：取反*/
	   EPwm1Regs.AQCTLB.bit.CAD = 1;
	   /*set  deadtime*/ 
	   EPwm1Regs.DBCTL.bit.IN_MODE = 0;              /*00:A的上升沿与下降沿 01:B上升沿与A下降沿 10:A上升沿与B下降沿 11:B的上升沿与下降沿*/
	   EPwm1Regs.DBCTL.bit.POLSEL = 2;           /*00:A、B都不反向　01:A反向 10:B反向 11:A、B都反向 ***(选择2为高有效，选择1为低有效)*/
...
void EPwmInt(void)
{
		...
		EPwm1Regs.ETSEL.bit.INTSEL = 0x001;      /*001:TBCTR=ZERO 010:TBCTR=PRD 100:TBCTR=CMPAU 101:TBCTR=CMPAD 110:TBCTR=CMPBU 111:TBCTR=CMPBD*/
