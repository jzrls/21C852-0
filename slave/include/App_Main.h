...
volatile _iq maxSpeed = _IQ(0);  // 高速模式转速
...
_iq m_PT_T[31] = {
    _IQ(0), _IQ(5), _IQ(10), _IQ(15), _IQ(20), _IQ(25), _IQ(30), _IQ(35),
    _IQ(40), _IQ(45), _IQ(50), _IQ(55), _IQ(60), _IQ(65), _IQ(70), _IQ(75),
    _IQ(80), _IQ(85), _IQ(90), _IQ(95), _IQ(100), _IQ(105), _IQ(110), _IQ(115),
    _IQ(120), _IQ(125), _IQ(130), _IQ(135), _IQ(140), _IQ(145), _IQ(150)};

volatile _iq MotorTM = 0;
volatile _iq igbtTemperatureProtectionValue = 0;
