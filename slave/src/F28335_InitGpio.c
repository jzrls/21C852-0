...
/*---------------------------------------------------------------------------
 ...
 GPxQSELx配置：0:Synch to SYSCLOUT(默认)  1:3*SYSCLOUT Sample  3:6*SYSCLOUT
Sample 3:Asynch(仅对功能口有效）;
                SCI、CAN输入脚均为异步；SPI脚均为异步；_TZx脚为异步，ECAP、EQEP均为同步
                数据总线配置为异步，地址总线不用
                与GPxCTRL配合得实际采样窗口为:2*2*GPxCTRL[QUALPRDn]*SYSCLKOUT（GPxQSELx=1）
或 5*2*GPxCTRL[QUALPRDx]*SYSCLKOUT（GPxQSELx=2）
----------------------------------------------------------------------------*/
void InitGpio(void) {
    EALLOW;
    /*=========================================================================
    ...
    GpioCtrlRegs.GPAMUX1.bit.GPIO7 =
        0; /*  00:GPIO7  01:EPWM4B  10:MCLKRA  11:ECAP2*/
    ...
    GpioCtrlRegs.GPAMUX1.bit.GPIO8 =
        0; /*  00:GPIO8  01:EPWM5A  10:CANTXB  11:_ADCSOCAO*/
    ...
    GpioCtrlRegs.GPAMUX1.bit.GPIO9 =
        0; /* 00:GPIO9  01:EPWM5B  10:SCITXDB  11:ECAP3*/
    ...
    GpioCtrlRegs.GPAMUX1.bit.GPIO10 =
        0; /* 00:GPIO10  01:EPWM6A  10:CANRXB  11:_ADCSOCB0*/
    ...
    GpioCtrlRegs.GPAMUX1.bit.GPIO11 =
        0; /* 00:GPIO11  01:EPWM6B  10:SCIRXDB  11:ECAP4*/
    ...
    GpioCtrlRegs.GPAMUX1.bit.GPIO14 =
        2; /* 00:GPIO14  01:_TZ3/XHOLD  10:SCITXDB  11:MCLKXB*/
    GpioCtrlRegs.GPAMUX1.bit.GPIO15 =
        2; /* 00:GPIO15  01:_TZ4/XHOLDA  10:SCIRXDB  11:MFSXB*/
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO16 =
        0; /* 00:GPIO16  01:SPISIMOA  10:CANTXB  11:_TZ5*/
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO17 =
        0; /* 00:GPIO17  01:SPIS0MIA  10:CANRXB  11:_TZ6*/
    GpioCtrlRegs.GPADIR.bit.GPIO17 = 1; /*  0:input  1:output*/

    GpioCtrlRegs.GPAMUX2.bit.GPIO18 =
        3; /* 00:GPIO18  01:SPICLKA  10:SCITXDB  11:CANRXA*/
    GpioCtrlRegs.GPAMUX2.bit.GPIO19 =
        3; /* 00:GPIO19  01:_SPISTEA  10:SCIRXDB  11:CANTXA*/
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO20 =
        0; /* 00:GPIO20  01:EQEP1A  10:MDXA  11:CANTXB*/
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO21 =
        0; /*  00:GPIO21  01:EQEP1B  10:MDRA  11:CANRXB*/
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO22 =
        0; /* 00:GPIO22  01:EQEP1S  10:MCLKXA  11:SCITXDB*/
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO23 =
        0; /* 00:GPIO23  01:EQEP1I  10:MFSXA  11:SCIRXDB*/
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO24 =
        0; /* 00:GPIO24  01:ECAP1  10:EQEP2A  11:MDXB*/
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO25 =
        0; /* 00:GPIO25  01:ECAP2  10:EQEP2B  11:MDRB*/
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO26 =
        0; /* 00:GPIO26  01:ECAP3  10:EQEP2I  11:MCLKXB*/
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO27 =
        0; /* 00:GPIO27  01:ECAP4  10:EQEP2S  11:MFSXB*/
    GpioCtrlRegs.GPADIR.bit.GPIO27 = 1; /*  0:input  1:output*/

    GpioCtrlRegs.GPAMUX2.bit.GPIO28 =
        1; /* 00:GPIO28  01:SCIRXDA  10:_XZCS6  11:XX*/
    GpioCtrlRegs.GPAMUX2.bit.GPIO29 =
        1; /*  00:GPIO29  01:SCITXDA  10:XA19  11:XX*/

    GpioCtrlRegs.GPAMUX2.bit.GPIO30 =
        2; /* 00:GPIO30  01:CANRXA  10:XA18  11:XX*/
    GpioCtrlRegs.GPAMUX2.bit.GPIO31 =
        2; /* 00:GPIO31  01:CANTXA  10:XA17  11:XX*/
    ...
    GpioCtrlRegs.GPBMUX1.bit.GPIO32 =
        0; /* 00:GPIO32  01:SDAA  10:EPWMSYNCI  11:_ADCSOCAO*/
    ...
    GpioCtrlRegs.GPBMUX1.bit.GPIO33 =
        0; /* 00:GPIO33  01:SCLA  10:EPWMSYNCO  11:_ADCSOCBO*/
    GpioCtrlRegs.GPBDIR.bit.GPIO33 = 1; /*  0:input  1:output*/

    GpioCtrlRegs.GPBMUX1.bit.GPIO34 =
        2; /* 00:GPIO34  01:ECAP1  10:XREADY  11:同10*/
    GpioCtrlRegs.GPBMUX1.bit.GPIO35 =
        2; /*00:GPIO35  01:SCITXDA  10:XR/_W  11:同10*/
    GpioCtrlRegs.GPBMUX1.bit.GPIO36 =
        2; /* 00:GPIO36  01:SCIRXDA  10:_XZCS0  11:同10*/
    GpioCtrlRegs.GPBMUX1.bit.GPIO37 =
        2; /* 00:GPIO37  01:ECAP2  10:_XZCS7  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX1.bit.GPIO40 =
        2; /* 00:GPIO40  01:XX  10:XA0/_XWE1  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO48 =
        0; /*  00:GPIO48  01:ECAP5  10:XD31  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO49 =
        0; /* 00:GPIO49  01:ECAP6  10:XD30  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO50 =
        0; /* 00:GPIO50  01:EQEP1A  10:XD29  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO51 =
        0; /* 00:GPIO51  01:EQEP1B  10:XD28  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO52 =
        0; /* 00:GPIO52  01:EQEP1S  10:XD27  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO57 =
        0; /* 00:GPIO57  01:_SPISTEA  10:XD22  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO58 =
        0; /* 00:GPIO58  01:MCLKRA  10:XD21  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO59 =
        0; /* 00:GPIO59  01:MFSRA  10:XD20  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO60 =
        0; /* 00:GPIO60  01:MCLKRB  10:XD19  11:同10*/
    ...
    GpioCtrlRegs.GPBMUX2.bit.GPIO61 =
        0; /* 00:GPIO61  01:MFSRB  10:XD18  11:同10*/
    GpioCtrlRegs.GPBDIR.bit.GPIO61 = 1; /*  0:input  1:output*/

    GpioCtrlRegs.GPBMUX2.bit.GPIO62 =
        1; /* 00:GPIO62  01:SCIRXDC  10:XD17  11:同10*/
    GpioCtrlRegs.GPBMUX2.bit.GPIO63 =
        1; /* 00:GPIO63  01:SCITXDC  10:XD16  11:同10*/
