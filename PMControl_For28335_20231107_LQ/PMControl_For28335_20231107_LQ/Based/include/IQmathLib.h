...
//--------------------------------------------------------------------------- 
// 用户需要配置  "MATH_TYPE" 和 "GLOBAL_Q" values:
//
//---------------------------------------------------------------------------
//选择 IQ_MATH or FLOAT_MATH:
//
...
#ifndef   MATH_TYPE
#define   MATH_TYPE      IQ_MATH              //选择IQ格式而非浮点格式
#endif
...
//---------------------------------------------------------------------------
// 如果你使用的是FLOAT_MATH,包括标准的头文件避免转换问题
...
#endif
//---------------------------------------------------------------------------
extern    long _atoIQN(const unsigned char *A, long q_value);
...
//---------------------------------------------------------------------------
extern    int __IQNtoa(unsigned char *A, const unsigned char *B, long C, int D);
extern    int _IQ30toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ29toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ28toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ27toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ26toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ25toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ24toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ23toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ22toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ21toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ20toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ19toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ18toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ17toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ16toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ15toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ14toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ13toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ12toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ11toa(unsigned char *A, const unsigned char *B, long C);
extern    int _IQ10toa(unsigned char *A, const unsigned char *B, long C);
extern    int  _IQ9toa(unsigned char *A, const unsigned char *B, long C);
extern    int  _IQ8toa(unsigned char *A, const unsigned char *B, long C);
extern    int  _IQ7toa(unsigned char *A, const unsigned char *B, long C);
extern    int  _IQ6toa(unsigned char *A, const unsigned char *B, long C);
extern    int  _IQ5toa(unsigned char *A, const unsigned char *B, long C);
extern    int  _IQ4toa(unsigned char *A, const unsigned char *B, long C);
extern    int  _IQ3toa(unsigned char *A, const unsigned char *B, long C);
extern    int  _IQ2toa(unsigned char *A, const unsigned char *B, long C);
extern    int  _IQ1toa(unsigned char *A, const unsigned char *B, long C);
